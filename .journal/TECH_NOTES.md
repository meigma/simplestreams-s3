...
- Phase 3 merged through PR #9 as `d6cc2a7`: publication now adopts compatible existing catalogs, verifies or repairs immutable content, and conditionally updates only `streams/v1/index.json` through bounded compare-and-swap retries. The V1 publish path is complete; Phase 4 owns production proxy behavior.
